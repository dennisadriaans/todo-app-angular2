    ...
    return {
        ...
        execute: function() {
            testComponent = (function () {
                function testComponent(params, _projectService, _todoService) {
                ...
                testComponent.prototype.openAddTodo = function () {
                    this.showTodoInput = true;
                };
                testComponent.prototype.closeAddTodo = function () {
                    this.showTodoInput = false;
                };
                testComponent.prototype.toggleEditTodoWindow = function (index) {
                ...
                testComponent.prototype.addTodo = function (project, todo) {
                    var _this = this;
                ...
                testComponent.prototype.markDone = function (project, todo) {
                    var _this = this;
                ...
                testComponent.prototype.markPrio = function (project, todo) {
                    var _this = this;
                    var index = project.todos.indexOf(todo);
                    todo.priority = 1;
                    this._todoService
                ...
                testComponent.prototype.Delete = function (project, todo) {
                    var _this = this;
                    var index = project.todos.indexOf(todo);
                ...
                testComponent.prototype.ClearInput = function () {
                    this.newTodo = {};
                };
                testComponent.prototype.stringAsDate = function (dateStr) {
                    return new Date(dateStr);
                };
                __decorate([
                    core_1.Input(), 
                    __metadata('design:type', Object)
                ], testComponent.prototype, "project", void 0);
            ...
            exports_1("default", testComponent);
        }
    }
});
