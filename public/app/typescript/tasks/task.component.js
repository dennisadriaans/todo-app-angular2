    ...
    return {
        ...
        execute: function() {
            taskComponent = (function () {
                function taskComponent(params, _projectService, _todoService) {
                ...
                taskComponent.prototype.ngOnInit = function () {
                    ...
                    ;
                    this._projectService.getProject(this.selectedProjectId)
                        .subscribe(function (project) { return _this.project = project; }, function (error) { return _this.errorMessage = error; });
                };
                taskComponent.prototype.openAddTodo = function () {
                    this.showTodoInput = true;
                };
                taskComponent.prototype.closeAddTodo = function () {
                    this.showTodoInput = false;
                };
                taskComponent.prototype.toggleEditTodoWindow = function (index) {
                ...
                taskComponent.prototype.addTodo = function (project, todo) {
                    var _this = this;
                ...
                taskComponent.prototype.markDone = function (project, todo) {
                    var _this = this;
                ...
                taskComponent.prototype.markPrio = function (project, todo) {
                    var _this = this;
                    var index = project.todos.indexOf(todo);
                    todo.priority = 1;
                    this._todoService
                ...
                taskComponent.prototype.Delete = function (project, todo) {
                    var _this = this;
                    var index = project.todos.indexOf(todo);
                ...
                taskComponent.prototype.ClearInput = function () {
                    this.newTodo = {};
                };
                taskComponent.prototype.stringAsDate = function (dateStr) {
                    return new Date(dateStr);
                };
                __decorate([
                    core_1.Input(), 
                    __metadata('design:type', Object)
                ], taskComponent.prototype, "project", void 0);
            ...
            exports_1("default", taskComponent);
        }
    }
});
